...
index = '/home/in/aeed/Work/October_Acquistion/index_multishell'
acqparams = '/home/in/aeed/Work/October_Acquistion/acqparams.txt' 
Wax_FA_Template = '/home/in/aeed/Work/standard/FMRIB58_FA_2mm.nii.gz'
Study_Template = '/home/in/aeed/Work/October_Acquistion/FA_Template_Cluster.nii.gz'
protocol = '/home/in/aeed/Work/October_Acquistion/MDT_multishell_protocol.prtcl'
...
def Kurtosis(dwi, mask):
	...
	return  DKI_FA, DKI_MD, DKI_AD, DKI_RD, DKI_MK, DKI_AK, DKI_RK



Kurtosis = Node(name = 'Kurtosis',
                  interface = Function(input_names = ['dwi','mask'],
                  					   output_names = ['DKI_FA', 'DKI_MD', 'DKI_AD', 'DKI_RD', 'DKI_MK', 'DKI_AK', 'DKI_RK'],
                  function = Kurtosis))
...
Multishell_workflow.connect ([
      ...
      (eddy, Kurtosis, [('out_corrected','dwi')]),
...
Multishell_workflow.run(plugin='SLURMGraph', plugin_args = {'dont_resubmit_completed_jobs':True})
