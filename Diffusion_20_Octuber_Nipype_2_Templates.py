...
#-----------------------------------------------------------------------------------------------------
# In[6]:
bval =  '/media/amr/HDD/Work/October_Acquistion/bval_20'
bvec =  '/media/amr/HDD/Work/October_Acquistion/bvec_20'
...
fit_tensor.inputs.bvals = '/media/amr/HDD/Work/October_Acquistion/bval_20'
fit_tensor.inputs.bvecs = '/media/amr/HDD/Work/October_Acquistion/bvec_20'
...
DTI_workflow.connect ([
      ...
      (eddy, fit_tensor, [('eddy_corrected','dwi')]),
...
DTI_workflow.run('MultiProc', plugin_args={'n_procs': 8})
